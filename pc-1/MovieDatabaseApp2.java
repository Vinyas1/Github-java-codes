...
public class MovieDatabaseApp2 {
    ...
    static class MovieDatabase {
        ...
        public Movie findMovie(String title) throws MovieNotFoundException {
            ...
            throw new MovieNotFoundException("Movie or series not found in the database."); // Throw exception if not found
        }
    }
